...
watercolor:
"将图中的宠物转化为艺术水彩纹身设计。【构图与虚实】采用虚实结合的手法：宠物的五官（眼睛、鼻镜）与面部核心轮廓使用柔和的细线条固定，确保结构清晰可辨；躯干部位和边缘则以半透明水彩笔触晕开，刻意保留「飞白」或「溅墨」效果，形成轻盈灵动的插画质感，而非传统纹身的厚重黑边。【色彩晕染】大量使用色块叠加与边缘扩散，模拟颜料遇水化开的质感。彻底摒弃大面积纯白与灰色块面——阴影区域主动引入薰衣草紫或天蓝，亮部使用蜜桃橙、金黄或玫瑰粉进行染色，整体色调明艳饱和，富有层次感与生命力。【配色规则】不论宠物原本毛色深浅，必须主动引入艺术性鲜活色彩。采用「负空间」手法，利用主体周围的水洗色层衬托宠物轮廓；严禁大面积出现纯白或灰白色块，色彩明快，不脏、不灰、不苍白。【笔触细节】笔触轻盈灵动，伴有自然的艺术墨滴喷溅；纯白背景隔离，整体呈现出高端艺术纸质感与电影级光影氛围，像一幅直接绘在皮肤上的插画作品。务必精准还原原图中宠物的面部比例与俏皮神态，尤其是双眼中清澈明亮的「眼神光」和五官细节。",
  outline:
